...
## Notebooks 📓
##### I have also taken the corresponding code on Kaggle Notebooks.
...
- Clone the complete project with `git clone https://github.com/mohammeddaniyaalullahkhan/AGRONOMISAGE.git` or you can just download the code and unzip it
- **Note:** The master branch doesn't have the updated code used for deployment, to download the updated code used for deployment you can use the following command
  ```
  ❯ git clone -b deploy https://github.com/mohammeddaniyaalullahkhan/AGRONOMISAGE.git 
  ```
...
#### If you have any doubt or want to contribute feel free to email me or hit me up on [LinkedIn](https://www.linkedin.com/in/daniyaalullah-khan-mohammed-70043620b/)
